...
"Note today’s date as ${date_today}. Parse for any specific dates or relative time indicators in the prompt (like 'yesterday,' '2 weeks ago,' etc.). If found, convert these relative terms into ISO date format (YYYY-MM-DD) based on today’s date. You may retrieve a maximum of two dates, labeled date1 and date2. If there are no dates, leave all values empty."
Validation:
...
// const response = await runcheckQuery('How much did I spend yesterday?');
